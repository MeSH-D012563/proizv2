...
from UI.addEditCoffeeForm_ui import Ui_Dialog as AddEditCoffeeFormUI
from PyQt6.QtWidgets import QTableWidgetItem


class CoffeeApp(QtWidgets.QMainWindow, MainWindowUI):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        self.load_data()
...
class AddEditCoffeeForm(QtWidgets.QDialog, AddEditCoffeeFormUI):
